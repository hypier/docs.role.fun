    ...
    async function generateReplicate() {
      ...
      const output: any = await replicate.run(modelHash as any, {
        input: {
          ...
          negative_prompt:
            "nsfw, lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry, artist name, rating: sensitive, loli, shota, young, diaper, scat, gore, vore, guro, cub",
          num_inference_steps:
